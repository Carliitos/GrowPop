...
<html>
    <head>
        ...
        <script type="text/javascript" src="functions/touchEvents.js"></script>
        <title>GrowPop</title>
    </head>
<?php
...
?>
    ...
    <body>
        ...
        <!-- START MOBILE VIEWER -->
        <div class="mobile" id="home">
            
            <div class="center-xs header-mob">
                <img class="header-logo-mob" style="margin-left: 6%;" src="img/logo.png">
                <a href="messages.php?id=<?php echo $_SESSION['user_name']; ?>" style="color:currentColor;"><i class="far fa-envelope" style="float: right; font-size: 25px; margin-top: 10px; margin-right: 4%"></i></a>
            </div>
            ...
            <div class="row center-xs all-mob-post">
                ...
                <!-- <div class="post-mob col-xs-12 col-sm-11">
                    ...
                    <small><span>username: frase</span></small>
                    </div>
                </div> -->
                <?php 
